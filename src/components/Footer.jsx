...
const Footer = () => {
  return (
    <div className="flex gap-5 w-full h-screen bg-zinc-900 px-20 py-10 ">
      <div className="w-1/2 h-full flex flex-col justify-between font-custom">
        <div className="heading">
          {["eye-", "opening"].map((item) => (
            <h1 className="text-[5vw] uppercase font-semibold leading-none tracking-tighter -mb-2">
              {item}
            </h1>
          ))}
        </div>
      ...
      <div className="w-1/2 h-full ">
        <div className="heading font-custom">
          <h1 className="text-[5vw] uppercase font-semibold leading-none tracking-tighter -mb-2">
            presentations
          </h1>
        </div>
        <div className="flex gap-5 h-full py-10 leading-tight">
          ...
          <div className="w-1/2 flex flex-col justify-end gap-28">
          <div className="flex flex-col">
